...
import logoMaximum from './../../assets/images/gymTwo.webp'
import gym from './../../assets/images/manGyn.webp'
    ...
    return (
        <section id="hero" className="">
            <div className="container">
                <div className="hero pt-[20%] filter-[1px] flex  items-center flex-col">
                    <div className="">
